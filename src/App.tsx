...
const svg = {
  start: { pathLengh: 0, fill: "rgba(255, 255, 255, 0)" },
  end: {
    ...
    <Wrapper>
      ...
      >
        <motion.path
          ...
          d="M224 373.12c-25.24-31.67-40.08-59.43-45-83.18-22.55-88 112.61-88
          90.06 0-5.45 24.25-20.29 52-45 83.18zm138.15 73.23c-42.06
